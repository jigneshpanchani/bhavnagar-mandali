         ...
         <!-- begin::Search-->
          ...
          <div class="topbar-item">
             ...
             <div class="btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                ...
                <!-- <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">User</span> -->
                <button class="symbol symbol-lg-35 symbol-25 symbol-light-success">
